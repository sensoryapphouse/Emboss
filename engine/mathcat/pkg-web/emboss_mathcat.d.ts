...
export interface InitOutput {
    ...
    readonly mathcat_version: () => [number, number];
    readonly mathml_to_braille: (a: number, b: number, c: number, d: number) => [number, number];
    readonly mathml_to_speech: (a: number, b: number) => [number, number];
    readonly speak_set_preference: (a: number, b: number, c: number, d: number) => [number, number];
    readonly supported_braille_codes: () => [number, number];
