 ...
 * @returns {string}
 */
export function mathcat_version() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
export function mathml_to_braille(mathml, code) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function mathml_to_speech(mathml) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(mathml, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function speak_set_preference(name, value) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function supported_braille_codes() {
    let deferred1_0;
    let deferred1_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('emboss_mathcat_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
